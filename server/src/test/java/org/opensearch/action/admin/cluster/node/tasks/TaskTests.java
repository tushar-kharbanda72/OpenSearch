...
public class TaskTests extends OpenSearchTestCase {
    ...
    public void testTaskResourceStats() {
        ...
        for (int i = 0; i < randomInt(10); i++) {
            ...
            task.addTaskResourceStats(i, ResourceStatsType.WORKER_STATS, initialTaskResourceMetrics);
            ...
            task.stopTaskResourceStats(i, ResourceStatsType.WORKER_STATS, taskResourceMetrics);
        }
